                ...
                Yii::$app->user->isGuest ? '' :
                    Html::tag('li',
                        Html::tag('span',
                            ...
                            '</strong><sub>/5</sub>&nbsp;&nbsp;&nbsp;Ú<sub>1</sub>b: <strong class="fw-500">' . Claim::find()->where(['user' => Yii::$app->user->id])->andWhere(['IS NOT', 'mutation_type', null])->count() .
                            '</strong><sub>/15</sub>&nbsp;&nbsp;&nbsp;Ú<sub>2</sub>a: <strong class="fw-500">' . Label::find()->where(['user' => Yii::$app->user->id, 'oracle' => true])->count() .
                            '</strong><sub>/5</sub>&nbsp;&nbsp;&nbsp;Ú<sub>2</sub>b</strong>: <strong class="fw-500">' . Label::find()->where(['user' => Yii::$app->user->id, 'oracle' => false])->count().'</strong><sub>/15</sub>'
