...
<div class="container">
    ...
    <div class="alert  mt-3 alert-warning alert-dismissible fade show" role="alert">
        ...
        <ul>
            ...
            <li>Pokud to zdrojový odstavec neumožňuje, nebo se Vám zdá nezajímavý, nebojte se ho  <?= Html::a('<i class="fas fa-forward"></i> Přeskočit', ['claim/annotate', 'sandbox' => $sandbox], ['class' => 'btn btn-light btn-sm']) ?>
            </li>
        </ul>
    </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        <li><strong>Každé vaše tvrzení by mělo být potenciálně zajímavé pro ověřování.</strong> Pokud vás pro daný zdrojový odstavec žádné rozumné tvrzení nenapadne, raději zvolte <?= Html::a('<i class="fas fa-forward"></i> Přeskočit', ['claim/annotate', 'sandbox' => $sandbox], ['class' => 'btn btn-light btn-sm']) ?>.</li>
