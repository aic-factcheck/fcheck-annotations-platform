...
<div class="container">
    ...
    <div class="row topmargin">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="callout">
                <h4>Guidelines</h4>
                <p>The objective of this task is to <strong>generate true claims</strong> from this source sentence that
                    was extracted from Wikipedia. </p>

                <ul>
                    <li><strong class="ng-binding">Extract simple factoid claims about Český kraulař Svoboda skončil na
                    ...
                    <li><strong>Avoid vague or cautions language</strong> (e.g. might be, may be, could be, is reported
                        that)
                    </li>
    ...
    <div class="row topmargin">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <div class="callout left">
                ...
                <p class="ng-binding">This is the sentence that is used to substantiate your claims about <?= $model->sentence['entity'] ?></p>
            </div>
        </div>
            ...
            <div class="callout left">
                ...
                <div ng-show="show_example" class="ng-hide">
                    <blockquote>The&nbsp;Amazon River, usually abbreviated to&nbsp;Amazon&nbsp;(US:&nbsp;/ˈæməzɒn/&nbsp;or&nbsp;UK:&nbsp;/ˈæməzən/;&nbsp;Spanish&nbsp;and&nbsp;Portuguese:&nbsp;Amazonas),
                        in&nbsp;South America&nbsp;is the&nbsp;largest river&nbsp;by&nbsp;discharge&nbsp;volume of water
                    ...
                    <ul>
                        <li>The Amazon is might be the longest river. <em>('might be' is cautious/vague language)</em>
                        </li>
