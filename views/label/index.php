...
<?php $form = ActiveForm::begin([
    ...
    <div class="container-fluid">
        <h1>Anotace správnosti výroku (Ú2)</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="ng-binding ng-scope">The purpose of this task is to identify evidence from a Wikipedia
                        ...
                        are generated by humans (as part of the Ú1 annotation workflow) from the Wikipedia page about
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="ng-scope">
                        ...
                        <br>
                        Výrok bude nahlášen ke kontrole, zda splňuje pokyny z Ú1.
                    </p>
                    <hr class="ng-scope">
                    <p class="ng-scope">
