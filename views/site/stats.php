        ...
        <?php foreach (User::find()->where(['>=','id',77])->all() as $user) {
            ...
            echo Html::tag('li',
                Html::tag('span',
                    ...
                    '</strong><sub>/3</sub>&nbsp;&nbsp;&nbsp;Ú<sub>1</sub>b: <strong class="fw-500">' . ($u1b = Claim::find()->where(['user' => $user->id])->andWhere(['IS NOT', 'mutation_type', null])->count()) .
                    '</strong><sub>/7</sub>&nbsp;&nbsp;&nbsp;Ú<sub>2</sub>a: <strong class="fw-500">' . ($u2a = Label::find()->where(['user' => $user->id, 'oracle' => true])->count()) .
                    '</strong><sub>/7</sub>&nbsp;&nbsp;&nbsp;Ú<sub>2</sub>b</strong>: <strong class="fw-500">' . ($u2b = Label::find()->where(['user' => $user->id, 'oracle' => false])->count()) . '</strong><sub>/35</sub> '
